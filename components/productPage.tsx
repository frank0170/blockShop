...
export default function ProductPage({ product }: any) {
  ...
  const tabContent = () => {
    switch (selectedTab) {
      case "description":
        return (
          <p className="flex justify-center text-center text-gray-700 mb-8">
            {product.description}
          </p>
        );
      case "specifications":
        return <SpecTable specs={product.specs} />;
      case "performance":
        return <PerformanceTable specs={product.performance} />;
  ...
  return (
    <div className="max-w-4xl mx-auto mt-20 md:mt-32">
      ...
      <div className="flex justify-center mb-4 flex-col md:flex-row mt-8">
        <button
          className="px-4 py-2  border-b-4 border-transparent hover:border-gray-500 focus:border-gray-500"
