...
import GamingPC from '@/public/images/pc1.jpeg'
import WorkstationPC from '@/public/images/pc2.jpeg'
import CadPC from '@/public/images/pc3.jpeg'
      ...
      <div className="py-12 md:py-20">
        ...
        <div className="max-w-xl lg:max-w-6xl mx-auto px-4 sm:px-6">
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            {/* Content */}
            <div className="lg:max-w-none lg:min-w-[324px]">
              <div className="mb-8">
                <div className="inline-flex text-sm font-medium text-zinc-400 px-4 py-0.5 border border-transparent [background:linear-gradient(theme(colors.zinc.800),theme(colors.zinc.800))_padding-box,linear-gradient(120deg,theme(colors.zinc.700),theme(colors.zinc.700/0),theme(colors.zinc.700))_border-box] rounded-full mb-4">Alege-ti configuratia</div>
                <h3 className="font-inter-tight text-3xl font-bold text-zinc-200 mb-4">Configuratile cel mai des intalnite</h3>
                <p className="text-lg text-zinc-500">Exista cateva tendinte pe partea de configurat calculatoare, fiecare cu diferite pune accent pe diferite specificatii.</p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0 space-y-2">
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Calculatoare Gaming</div>
                    <div className="text-zinc-500">Configurate pentru performanțe extreme, cu procesoare puternice și plăci grafice de ultimă generație.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Statii de lucru</div>
                    <div className="text-zinc-500">Echipate cu procesoare multi-core și memorie RAM extensivă pentru sarcini de procesare intensivă.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Statii de proiectare</div>
                    <div className="text-zinc-500">Dotate cu plăci video specializate și memorie rapidă pentru manipularea eficientă a modelelor complexe CAD.</div>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="relative lg:max-w-none pt-0 md:pt-32">
              <div className="relative flex flex-col" ref={tabs}>
                ...
                >
                  <div>
                    <Image className="lg:max-w-none mx-auto rounded-lg shadow-2xl" src={GamingPC} width={500} alt="Carousel 01" />
                  </div>
                </Transition>
                {/* Item 2 */}
                <Transition
                ...
                >
                  <div>
                    <Image className="lg:max-w-none mx-auto rounded-lg shadow-2xl" src={WorkstationPC} width={500} alt="Carousel 02" />
                  </div>
                </Transition>
                {/* Item 3 */}
                <Transition
                ...
                >
                  <div>
                    <Image className="lg:max-w-none mx-auto rounded-lg shadow-2xl" src={CadPC} width={500}  alt="Carousel 03" />
                  </div>
                </Transition>
              </div>
              {/* Gear illustration */}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Discuții preliminare</h3>
              </div>
              <p className="text-sm text-zinc-500"> Identificarea obiectivelor și cerințelor proiectului în sesiuni informative.</p>
            </div>
            {/* Block #2 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Perspectiva echipei</h3>
              </div>
              <p className="text-sm text-zinc-500">Abordarea problemelor și soluțiilor din diverse unghiuri și experiențe.</p>
            </div>
            {/* Block #3 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Research</h3>
              </div>
              <p className="text-sm text-zinc-500">Cercetarea detaliată a informațiilor relevante și a soluțiilor existente.</p>
            </div>
            {/* Block #4 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Analiză</h3>
              </div>
              <p className="text-sm text-zinc-500">Evaluarea critică a datelor și a posibilelor opțiuni de acțiune.</p>
            </div>
            {/* Block #5 */}
            <div>
              <div className="flex items-center mb-1">
              <svg className="fill-zinc-400 mr-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Testare</h3>
              </div>
              <p className="text-sm text-zinc-500">Verificarea performanței și a funcționalității în medii de testare controlate.</p>
            </div>
            {/* Block #6 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Implementare</h3>
              </div>
              <p className="text-sm text-zinc-500">Aplicarea soluției alese și integrarea acesteia în sistemul existent.</p>
            </div>
          </div>
        </div>
