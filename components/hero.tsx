...
import HeroImage from '@/public/images/mainPc.png'
          ...
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">
                  Calculatoare <em className="italic relative inline-flex justify-center items-center text-zinc-900"> custom
                  ...
                  </em> pentru viata de zi cu zi
                </h1>
                <p className="text-lg text-zinc-500 mb-8">
Construim statii de lucru bazate pe cerintele clientului. Oferim consultanta pe tot parcursul dezvoltarii si implementarii.</p>
                <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <div>
                    <Link className="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow" href="/request-demo">Vezi ofertele</Link>
                  </div>
                  <div>
                    <a className="btn text-zinc-600 bg-white hover:text-zinc-900 w-full shadow" href="#0">Contacteaza-ne</a>
                  </div>
                </div>
              </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex justify-center pb-12 md:pb-20 relative before:absolute before:-top-12 before:w-96 before:h-96 before:bg-zinc-900 before:opacity-[.15] before:rounded-full before:blur-3xl before:-z-10">
          <Image src={HeroImage} width={1104} height={620} alt="Hero" priority />
        </div>
