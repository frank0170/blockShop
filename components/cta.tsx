      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 mb-4">Contacteaza echipa <em className="relative not-italic inline-flex justify-center items-end pr-2">
               BlockArch 
               ...
               pentru a pune in practica proiectele tale.
            </h2>
            <p className="text-lg text-zinc-500 mb-8">Va invitam sa aruncati un ochi peste ofertele noastre deja configurate sau va asteptam pe email pentru orice intrebari.</p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <div>
                <a className="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow" href="/request-demo">Vezi ofertele</a>
              </div>
              <div>
                <a className="btn text-zinc-600 bg-white hover:text-zinc-900 w-full shadow" href="#0">Contact</a>
              </div>
            </div>
          </div>
          {/* Clients */}
