      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12">
            <h2 className="font-inter-tight text-3xl font-bold text-zinc-900">Join the Community</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-4 lg:gap-8">
            ...
            <div className="flex flex-col p-4 border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.white))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg shadow shadow-black/5">
              ...
              <p className="grow text-sm text-zinc-500">Ne gasiti si pe Discord pentru converatii!</p>
            ...
            <div className="flex flex-col p-4 border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.white))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg shadow shadow-black/5">
              <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-zinc-800 rounded-full flex items-center justify-center mr-3">
                  <svg className="fill-zinc-100" xmlns="http://www.w3.org/2000/svg" width="20" height="19">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-800">GitHub</h3>
              </div>
              <p className="grow text-sm text-zinc-500">Echipa noastra se ocupa si de realizat sofware la comanda!</p>
              <div className="text-right">
                <a className="inline-flex items-center font-medium text-sm mt-4" href="#0">
                  Contribute
                  <svg className="shrink-0 ml-1 fill-current" xmlns="http://www.w3.org/2000/svg" width="9" height="9">
            ...
            <div className="flex flex-col p-4 border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.white))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg shadow shadow-black/5">
              <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-zinc-800 rounded-full flex items-center justify-center mr-3">
                  <svg className="fill-zinc-100" xmlns="http://www.w3.org/2000/svg" width="18" height="16">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-800">Twitter / X</h3>
              </div>
              <p className="grow text-sm text-zinc-500">Urmareste-ne pnetru noutati!</p>
              <div className="text-right">
                <a className="inline-flex items-center font-medium text-sm mt-4" href="#0">
                  Follow us
                  <svg className="shrink-0 ml-1 fill-current" xmlns="http://www.w3.org/2000/svg" width="9" height="9">
