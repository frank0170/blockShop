          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-6 lg:gap-16 text-center">
            ...
            <div>
              <div className="w-8 h-8 bg-slate-50 border border-zinc-200 rounded-md inline-flex items-center justify-center mb-3">
                <svg className="fill-zinc-800" xmlns="http://www.w3.org/2000/svg" width="16" height="17">
              ...
              <h3 className="font-inter-tight font-semibold text-zinc-800 mb-1">Custom</h3>
              <p className="text-sm text-zinc-500">Echipa BlockArch vă ajută să alegeți configuratia potrivita pentru dvs.</p>
            </div>
            {/* Item #2 */}
            <div>
              <div className="w-8 h-8 bg-slate-50 border border-zinc-200 rounded-md inline-flex items-center justify-center mb-3">
                <svg className="fill-zinc-800" xmlns="http://www.w3.org/2000/svg" width="14" height="13">
              ...
              <h3 className="font-inter-tight font-semibold text-zinc-800 mb-1">Testare</h3>
              <p className="text-sm text-zinc-500">Testam fiecare configuratie inante sa-o trimitem spre client.</p>
            </div>
            {/* Item #3 */}
            <div>
              <div className="w-8 h-8 bg-slate-50 border border-zinc-200 rounded-md inline-flex items-center justify-center mb-3">
                <svg className="fill-zinc-800" xmlns="http://www.w3.org/2000/svg" width="16" height="14">
              ...
              <h3 className="font-inter-tight font-semibold text-zinc-800 mb-1">Implementare</h3>
              <p className="text-sm text-zinc-500">La colaborari mai mari, oferim si deplasare si implementare la adresa clientului.</p>
            </div>
          </div>
        </div>
      </div>
